...
from app.domains.stores.routes import router as stores_router
...
from app.domains.users.routes import platform_store_users_router
...
no_system_router.include_router(platform_store_users_router)
no_system_router.include_router(stores_router)
